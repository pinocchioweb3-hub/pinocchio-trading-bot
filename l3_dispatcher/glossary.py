...
GLOSSARY_VERSION = "1.0"  # 隨術語增修調版號（未來信任網頁/Agent 可據此判快取）
...
TERMS: tuple[Term, ...] = (
    ...
    Term("r_multiple", "R 倍數", "R",
         "把「一筆願意虧的錢」當成 1 個單位（1R）。賺 2R 就是賺了 2 倍當初的風險。",
         "用 R 看績效比看金額公平：不管本金多大，+1R 就是賺到一倍風險、-1R 就是賠掉一次預算。",
    ...
    Term("leverage", "槓桿", "Leverage",
         "借錢放大部位。10x 代表用 1 塊本金開 10 塊的單。",
         "槓桿只放大「保證金效率」，不改變你設定的 1R 風險金額（風險由止損距離決定）。",
         "槓桿越高，離強制平倉（爆倉）價越近。本工具用槓桿管保證金，不是用來賭更大。",
         "risk"),
